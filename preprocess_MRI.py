...
class LITS_preprocess:
    ...
    def fix_data(self):
        ...
        file_list = os.listdir(join(self.raw_root_path,'MRI'))
        ...
        for ct_file,i in zip(file_list,range(Numbers)):
            ...
            ct_path = os.path.join(self.raw_root_path, 'MRI', ct_file)
            ...
            if new_ct != None and new_seg != None:
                sitk.WriteImage(new_ct, os.path.join(self.fixed_path, 'MRI', ct_file))
    ...
    def write_train_val_name_list(self):
        ...
        test_name_list = data_name_list[int(data_num*(1-self.test_rate)):int(data_num*((1-self.test_rate) + self.test_rate))]
...
if __name__ == '__main__':
    ...
    fixed_dataset_path = 'dataset/fixed_data'
